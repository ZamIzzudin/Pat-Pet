                  ...
                  if (!connected) {
                    return (
                      <button
                        ...
                        type="button"
                        className="bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-lg text-sm transition-colors font-semibold"
                  ...
                  if (chain.unsupported) {
                    return (
                      <button
                        ...
                        type="button"
                        className="bg-red-600 hover:bg-red-700 text-white py-2 px-4 rounded-lg text-sm transition-colors font-semibold"
                      >
                        Wrong network
                      </button>
                    );
                  ...
                  return (
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        type="button"
                        className="bg-green-600 hover:bg-green-700 text-white py-2 px-3 rounded-lg text-sm transition-colors font-semibold"
                      >
                        {account.displayName}
      ...
      {!wallet && !isConnecting && (
        <div className="bg-black bg-opacity-80 text-white p-4 rounded-lg text-sm max-w-xs">
          ...
          <p className="text-xs text-gray-300 mb-3">
            Connect your wallet to start playing with your NFT pets on Monad Testnet
          </p>

          <div className="text-xs text-yellow-400">
            ⚠️ Make sure you're on Monad Testnet
          </div>
        </div>
      )}
    </div>
