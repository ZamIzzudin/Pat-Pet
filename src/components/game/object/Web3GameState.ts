...
import { EventBus, GAME_EVENTS, Web3GameData, PetData as Web3PetData } from "@/lib/eventBus";
...
export default class Web3GameState extends GameState {
  ...
  private setupEventListeners() {
    ...
    this.eventBus.on(GAME_EVENTS.WALLET_CONNECTED, this.handleWalletConnected.bind(this));
    this.eventBus.on(GAME_EVENTS.WALLET_DISCONNECTED, this.handleWalletDisconnected.bind(this));
    this.eventBus.on(GAME_EVENTS.PETS_DATA_UPDATED, this.handlePetsDataUpdated.bind(this));
    this.eventBus.on(GAME_EVENTS.SELECTED_PET_CHANGED, this.handleSelectedPetChanged.bind(this));
  }
